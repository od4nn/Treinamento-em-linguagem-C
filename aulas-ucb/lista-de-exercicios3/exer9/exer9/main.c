...
int main() {
	int n_usuario, n_maior = 0, n_menor = 0, contador = 0, resultado_leitura;
	...
	while(1){
		do{
			...
			resultado_leitura = scanf("%d", &n_usuario); //verifica se scanf leu um numero

			if(resultado_leitura != 1){ //se leu uma letra, avisa ao usuario e encerra o programa
